...
#define HOMING_BUMP_MM      { 5, 5, 1.5 }       // (mm) Backoff from endstops after first bump
#define HOMING_BUMP_DIVISOR { 10, 6, 8 }       // Re-Bump Speed Divisor (Divides the Homing Feedrate)
 ...
 */
#define XY_FREQUENCY_LIMIT      5 // (Hz) Maximum frequency of small zigzag infill moves. Set with M201 F<hertz>.
